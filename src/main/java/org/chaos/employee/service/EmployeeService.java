package org.chaos.employee.service;

import org.chaos.employee.exception.EmployeeNotFoundException;
import org.chaos.employee.exception.EmployeeValidationException;
import org.chaos.employee.model.Employee;
import org.chaos.employee.repository.EmployeeRepository;
...
public class EmployeeService {
    ...
    public List<Employee> getAll() {
        ...
        /*} catch (Exception e) {
            ...
            System.out.println("Caught an Exception....");/employees = new ArrayList<>();
        }*/
        return employees;
    }
